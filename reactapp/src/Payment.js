...
const ButtonWithNotification = () => {
  ...
  return (
    <div className='paymentalcy'>
   <div class="paymani"><br></br><br></br><br></br><br></br><br></br>
  <div class="paycon">
      <svg id="payexit" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M3 13.4597C3 17.6241 6.4742 21 10.7598 21C14.0591 21 16.8774 18.9993 18 16.1783C17.1109 16.5841 16.1181 16.8109 15.0709 16.8109C11.2614 16.8109 8.17323 13.8101 8.17323 10.1084C8.17323 8.56025 8.71338 7.13471 9.62054 6C5.87502 6.5355 3 9.67132 3 13.4597Z" stroke="#1B1B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
   ...
   <Link to="/Ticket"><h6 className='grabbing'>Grab your Tickets!!!</h6></Link>
    </div>
    <br></br><br></br>
    <label className="payname"for="name11">Name</label>< br></br>
      <input type="text" id="payname" name="name" placeholder="Name"/>
    <br></br>
    <label className="paycard"for="card11">Card number</label><br></br>
      <input type="text" minlength="16" maxlength="16" id="paycard" name="card" placeholder="0000 0000 0000 0000"/>
    <br></br><br></br><br></br><br></br>
    <div class="payexp">
      <div class="payexpiration">
    <label className="payexp1"for="expiry11">Expiration date</label><br></br>
      <input class="payinput" name="expiry" id="payexp" type="text" required placeholder="00/00"/>
      <br></br>
      </div>
      <div class="paysecurity">
    <label className="paycvc11"for="cvc11">CVC</label><br></br>
      <input type="text" minlength="3" maxlength="4" id="paycvc" name="cvc" placeholder="XXX" />
    <br></br>
      </div>
    </div>
  <div class="paybtn112">
  
  <svg width="424" height="104" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M6.48641 9.36289C6.65786 8.87904 7.34214 8.87904 7.51358 9.36289L7.9824 10.686C8.03728 10.8409 8.15913 10.9627 8.31401 11.0176L9.63711 11.4864C10.121 11.6579 10.121 12.3421 9.63711 12.5136L8.31401 12.9824C8.15913 13.0373 8.03728 13.1591 7.9824 13.314L7.51358 14.6371C7.34214 15.121 6.65786 15.121 6.48641 14.6371L6.0176 13.314C5.96272 13.1591 5.84087 13.0373 5.68599 12.9824L4.36289 12.5136C3.87904 12.3421 3.87904 11.6579 4.36289 11.4864L5.68599 11.0176C5.84087 10.9627 5.96272 10.8409 6.0176 10.686L6.48641 9.36289Z" stroke="#1B1B1B" stroke-width="1.5" stroke-linejoin="round"/>
      ...
      <button id="paysubmit112" onClick={handleButtonClick} >Submit</button>
      {showNotification && <div className="paynotification">Payment SuccesFull!</div>}
    </div>
  </div>
  </div>
  </div>
